...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    var heartElement = _this.heart; // named elements can be accessed from the parent element
    var isHearted = heartElement.classList.toggle("heart__button--hearted");
    (0, _bling.$)(".heart-count").textContent = res.data.hearts.length; // new length of users hearts array;
    if (isHearted) {
      var HEART_ANIMATION_CLASS = "heart__button--float";
...
function loadPlaces(map) {
  ...
  _axios2.default.get("/api/stores/near?lat=" + lat + "&lng=" + lng).then(function (response) {
    ...
    markers.forEach(function (marker) {
      return marker.addListener("click", function (params) {
...
function typeAhead(search) {
  ...
  var searchResults = search.querySelector("div.search__results");
...
var _makeMap = __webpack_require__(12);
